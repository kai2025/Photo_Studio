...
namespace Photo_StudioAPI.Controllers
{
    ...
    [ApiController]
    public class ReservasesController : ControllerBase
    {
        private readonly PhotoStudioDbContext _context;

        public ReservasesController(PhotoStudioDbContext context)
        {
            _context = context;
        }
